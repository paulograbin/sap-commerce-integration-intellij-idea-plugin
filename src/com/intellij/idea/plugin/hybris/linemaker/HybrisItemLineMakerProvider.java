...
public class HybrisItemLineMakerProvider extends RelatedItemLineMarkerProvider {
    ...
    private void createTargetsWithGutterIcon(
        ...
        builder.setPopupTitle(HybrisI18NBundleUtils.message("hybris.bean.class.navigate.choose.class.title"));
        builder.setTooltipText(HybrisI18NBundleUtils.message("hybris.item.class.tooltip.navigate.declaration"));
